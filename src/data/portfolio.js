export const personalInfo = {
  ...
  summary: "Senior Full Stack Developer with 2+ years of experience designing, developing, and delivering high-performance SaaS web applications. Proficient in React.js, TypeScript, Node.js, and Express.js with hands-on expertise in scalable PWA architecture, RESTful API development, and cloud infrastructure on AWS. Experienced in integrating AI and LLM APIs (OpenAI, Google Gemini, RAG pipelines) into production systems. Skilled in Agile methodologies, cross-functional team collaboration, and driving product delivery from concept to production.",
  yearsOfExperience: 2,
  currentRole: "Sr. Software Developer — Walstar Technologies",
  philosophy: "I believe in building software that is not just functional, but elegant. Every line of code should serve a purpose, every component should be reusable, and every user interaction should feel intentional.",
};
...
export const experience = [
  {
    ...
    description: "Leading full-stack development of scalable SaaS web applications using React.js, TypeScript, TanStack Query, and MUI X, supporting 500+ active users across a production PWA.",
    responsibilities: [
      "Led full-stack development of scalable SaaS web applications using React.js, TypeScript, TanStack Query, and MUI X, supporting 500+ active users across a production PWA",
      ...
      "Engineered the Bynaus AI Companion integrating OpenAI, Google Gemini, LiteLLM, and Ragie for multi-agent chat, AI-assisted contract reviews, and workflow DAGs",
    ...
    achievements: [
      ...
      "Improved delivery timelines by 15% through code reviews and Git branching workflows",
      "Supported 500+ active users with 99.9% uptime across the production PWA",
    ],
    technologies: ["React", "TypeScript", "Node.js", "Express", "MongoDB", "AWS", "OpenAI", "Google Gemini", "Redis", "Auth0", "Stripe"],
  },
  {
    id: 2,
    ...
    description: "Built and maintained responsive React.js interfaces using JavaScript (ES6+), HTML5, and CSS3, delivering production-ready features across multiple client projects.",
    responsibilities: [
      ...
      "Implemented RESTful API integrations and collaborated within Agile cross-functional teams to resolve bugs and ensure seamless frontend-backend integration",
      "Contributed to sprint planning and code reviews; improved component reusability by introducing shared UI component libraries",
    ],
    achievements: [
...
export const skills = {
  Frontend: [
    ...
    { name: "React Router v7", level: 88, years: 2 },
  ],
  Backend: [
    ...
    { name: "node-cron", level: 78, years: 1 },
  ],
  "AI & Integrations": [
    ...
    { name: "Firebase Admin", level: 80, years: 1 },
  ],
  "Database & Cloud": [
  ...
  "Tools & Practices": [
    ...
    { name: "Code Review", level: 88, years: 2 },
  ],
  Libraries: [
    { name: "Formik", level: 82, years: 1 },
    { name: "Recharts / D3", level: 75, years: 1 },
    { name: "Apryse WebViewer", level: 72, years: 1 },
    { name: "dnd-kit", level: 70, years: 1 },
    { name: "i18next", level: 72, years: 1 },
    { name: "ExcelJS", level: 70, years: 1 },
  ],
};
...
export const projects = [
  {
    ...
    shortDescription: "Full-stack SaaS platform that turns uploaded documents into a searchable knowledge base — ask questions in plain English and get grounded RAG answers with source citations.",
    image: "/projects/nexora.jpg",
    problem: "Teams drowning in PDFs, contracts, and reports need a way to query their documents without manually searching through files. Generic chatbots hallucinate without source grounding.",
    solution: "Built NEXORA — a multi-tenant AI knowledge workspace with document ingestion, vector search, streaming RAG chat, team collaboration, usage analytics, and tiered billing. Runs in demo mode out of the box or connects to MongoDB, Redis, S3, and OpenAI for production.",
    features: [
    ...
    techStack: ["Next.js", "TypeScript", "MongoDB", "Redis", "BullMQ", "OpenAI", "Tailwind CSS", "TanStack Query", "Zustand", "Zod"],
    challenges: [
    ...
    metrics: { performance: "96", loadTime: "1.1s", features: "12+" },
  ...
  },
  {
    ...
    shortDescription: "Premium café website for a fictional artisan coffee house with a cinematic hero, data-driven menu with filtering and search, masonry gallery with lightbox, and a validated reservations form.",
    image: "/projects/ember-and-bean.jpg",
    problem: "Most café websites are generic templates that feel the same. Ember & Bean needed a premium brand experience that matched a real artisan coffee house, with fast load times and a strong mobile experience.",
    solution: "Designed and built a premium editorial-style website with subtle glassmorphism, Playfair Display + Inter typography, and a warm espresso/cream palette. Menu is data-driven with category filtering, search and empty states. Gallery uses a masonry layout with a full keyboard- and swipe-friendly lightbox.",
    features: [
    ...
    metrics: { performance: "97", loadTime: "0.9s", pages: "6" },
    deployment: "Vercel",
  ...
  },
  {
    ...
    shortDescription: "Multi-tenant SaaS platform for full-lifecycle construction management with AI Companion, GPS-based workforce tracking, and real-time document workflows — live at bynaus.ai.",
    image: "/projects/bynaus.png",
    problem: "Construction companies struggle with fragmented project management tools that don't integrate workforce tracking, document workflows, and AI-assisted decision making into a unified platform.",
    solution: "Built a scalable multi-tenant SaaS web application covering project setup, cost codes, daily reporting, drawings, submittals, RFIs, and document transmittals with integrated AI and GPS tracking.",
    features: [
    ...
    techStack: ["React", "TypeScript", "Node.js", "Express", "MongoDB", "AWS", "OpenAI", "Google Gemini", "Redis", "Auth0", "Stripe"],
    challenges: [
    ...
    contributions: [
      "Architected the entire multi-tenant SaaS platform",
      "Built the AI Companion integrating OpenAI, Gemini, LiteLLM, and Ragie",
      "Implemented GPS-based attendance with AWS Rekognition face recognition",
      "Engineered PDF vector engine for architectural drawing workflows",
    ],
    metrics: { performance: "95", loadTime: "1.2s", uptime: "99.9%" },
  ...
  },
  {
    ...
    shortDescription: "Multi-portal sports management platform for admins, coaches, and members with roster scheduling, team communications, and role-based access control.",
    image: "/projects/yau-teamup.png",
    problem: "Youth athletic organizations struggle with fragmented communication between admins, coaches, and members, leading to scheduling conflicts and inefficient roster management.",
    solution: "Created a scalable multi-portal web application handling complex roster scheduling, team communications, and role-based access with Firebase-powered backend.",
    features: [
    ...
    metrics: { performance: "92", loadTime: "1.4s", uptime: "99.9%" },
  ...
  },
  {
    ...
    shortDescription: "Full-stack administrative dashboard managing a library of 5,000+ media assets with secure role-based access control and optimized data retrieval pipelines.",
    problem: "Music therapy facilities need a centralized admin dashboard to manage thousands of media assets with secure access control and efficient data retrieval.",
    solution: "Built a full-stack admin dashboard with Node.js/Express APIs, MongoDB storage for 5,000+ assets, and optimized retrieval pipelines reducing backend latency.",
    features: [
    ...
    metrics: { performance: "90", loadTime: "1.5s", uptime: "99.8%" },
